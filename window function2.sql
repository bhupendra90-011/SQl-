...
-- over() ==>  aseneding order me range kerke lana 
-- running sum/ cummlative sum of salary 
...
-- rank() ==> 
-- ager values same ho to  vo use  next rank ko ski p ker deti he 
-- differnec between , row_number, densrank, 
-- rank() -->  rank function is used to  and next rank is skip
-- dense_rank -->>  in functiom me next rank skip nhi hoti he 
