...
-- table is a join  itsellef is called  as self join 
...
-- in refernece of manager
select manager.emp_id,manager.emp_name  from employee as manager;


select emp.emp_id, emp.emp_name, emp.manager_id, emp.salary ,manager.emp_id,
 manager.emp_name, manager.salary from employee as emp
