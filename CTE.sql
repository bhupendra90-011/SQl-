...
-- ek temparory name on  for sql query 
-- theerr is not store in permanent  
-- it help to break  down complex  quries  into smaller, logical parts 
...
-- correlated 
select emp_id,  emp_name, department, salary from employees as e 
